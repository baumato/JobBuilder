...
public class View extends ViewPart {
	...
	private void lowestPriorityJob() {
		...
		btnButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				Jobs.builder().title(title).lowestPriority().runnable(new TestRunnable(8)).buildAndSchedule();
			}
		});
	}
	...
	private void notConcurrentlyJob() {
		...
		btnButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				Jobs.builder().title(title).runsNotConcurrently(title).runnable(new TestRunnable()).buildAndSchedule();
			}
		});
	}
